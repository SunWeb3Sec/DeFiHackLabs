...
address constant ATTACKER = address(uint160(0x004cf8Ed875e508c3acd60E56a1Ca21395D106bc94));
address constant HISTORICAL_ATTACK_CONTRACT = address(uint160(0x005f3697BB418A55E941d14f4DeF8D18BE73D66309));
...
address constant CURVE_USDT_USDAF_LP = address(uint160(0x004f493B7dE8aAC7d55F71853688B1F7C8f0243c85));
address constant CURVE_USDAF_POOL = address(uint160(0x0095591348fE9718BE8BFA3afcC9b017D9ec18a7fA));
address constant TROVE_MANAGER = address(uint160(0x00A0290af48D2e43162A1A05ab9D01A4CA3a8b60cB));
address constant ACTIVE_POOL = address(uint160(0x00d7954A8c7FA74c97aD2545719Ce82EAE915D73F7));
address constant USDAF = address(uint160(0x0085e30b8B263bC64d94b827Ed450F2EdFEE8579DA));
address constant SCRVUSD = address(uint160(0x000655977fEB2f289A4Ab78af67BAB0d17aAB84367));
address constant CURVE_SCRVUSD_SUSDE_POOL = address(uint160(0x00D29F8980852c2c76fC3F6E96A7aA06E0BEDCC1B1));
