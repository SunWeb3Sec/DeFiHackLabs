...
contract ContractTest is Test {
    ...
    IERC20 private constant BH =
        IERC20(0xCC61CC9F2632314c9d452acA79104DDf680952b5);
    ...
    address private constant unverifiedContractAddr2 =
        0x5b9dd1De70320B1EA6C8BBebA12bf4e246227999;
    address private constant busdt_bh_lp =
    ...
    function testExploit() public {
        ...
        emit log_named_decimal_uint(
            "Attacker BH balance before attack",
            BH.balanceOf(address(this)),
            BH.decimals()
        );
        ...
        emit log_named_decimal_uint(
            "Attacker BH balance after attack",
            BH.balanceOf(address(this)),
            BH.decimals()
        );
    }
