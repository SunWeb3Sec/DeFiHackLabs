...
contract ContractTest is Test {
    ...
    IERC20 private constant GHT = IERC20(0x528e046ACfb52bD3f9c400e7A5c79A8a2c2863d0);
    Uni_Pair_V2 private constant WETH_GHT = Uni_Pair_V2(0x706206EabD6A70ca4992eEc1646B6D1599259CAe);

    function setUp() public {
        vm.createSelectFork("mainnet", bytes32(0xd17266bcdf30cbcbd7d0b5a006f43141981aeee2e1f860f68c9a1805ecacbc68));
