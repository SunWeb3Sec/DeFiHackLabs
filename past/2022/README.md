...
```sh
forge test --contracts ./src/2022-11/others/AUR_exp.sol -vvv
```
...
```sh
forge test --contracts ../../src/test/2022-11/MEV_0ad8.t.sol -vvvv
```

#### Contract

[MEV_0ad8.t.sol](../../src/test/2022-11/MEV_0ad8.t.sol)
...
```sh
forge test --contracts ./src/test/2022-10/TeamFinance.exp.sol -vvv
```

#### Contract

[TeamFinance.exp.sol](../../src/test/2022-10/TeamFinance.exp.sol)
...
```sh
forge test --contracts ./src/test/2022-10/Market_exp.t.sol -vv
```

#### Contract

[Market_exp.t.sol](../../src/test/2022-10/Market_exp.t.sol)
...
```sh
forge test --contracts ./src/test/2022-10/OlympusDao.exp.sol -vvv
```

#### Contract

[OlympusDao.exp.sol](../../src/test/2022-10/OlympusDao.exp.sol)
...
```sh
forge test --contracts ../../src/test/2022-10/RabbyWallet_SwapRouter.exp.sol -vv
```

#### Contract

[RabbyWallet_SwapRouter.exp.sol](../../src/test/2022-10/RabbyWallet_SwapRouter.exp.sol)
...
[RES02_exp.sol](../../src/test/2022-10/RES02_exp.sol)
...
```sh
forge test --contracts ../../src/test/2022-10/THB_exp.sol -vv
```

#### Contract

[THB_exp.sol](../../src/test/2022-10/THB_exp.sol)
...
```sh
forge test --contracts ./src/test/2022-08/LuckyTiger_exp -vvv
forge script script/LuckyTiger_s_exp.sol:luckyHack --fork-url http://127.0.0.1:8545 --private-key $PRIVATE_KEY --broadcast
```

#### Contract

[LuckyTiger_exp.sol](../../src/test/2022-08/LuckyTiger_exp.sol) | [LuckyTiger_s_exp.sol](/script/LuckyTiger_s_exp.sol)
...
```sh
forge test --contracts ./src/test/2022-08/XST.exp.sol -vvv
```

#### Contract

[XST.exp.sol](../../src/test/2022-08/XST.exp.sol)
[XST02_exp.sol](../../src/test/2022-08/XST02_exp.sol)
...
```sh
forge test --contracts ./src/test/2022-08/EGD-Finance.exp.sol -vvv
```

#### Contract

[EGD-Finance.exp.sol](../../src/test/2022-08/EGD-Finance.exp.sol)
...
```sh
forge test --contracts ./src/test/2022-08/NomadBridge.exp.sol -vvv
```

#### Contract

[NomadBridge.exp.sol](../../src/test/2022-08/NomadBridge.exp.sol)
...
```sh
forge test --contracts ./src/test/2022-08/ReaperFarm.exp.sol -vvv
```

#### Contract

[ReaperFarm.exp.sol](../../src/test/2022-08/ReaperFarm.exp.sol)
...
```sh
forge test --contracts ./src/test/2022-07/LPC.exp.sol -vvv
```

#### Contract

[LPC.exp.sol](../../src/test/2022-07/LPC.exp.sol)
...
```sh
forge test --contracts ./src/test/2022-07/Audius.exp.sol -vvv
```

#### Contract

[Audius.exp.sol](../../src/test/2022-07/Audius.exp.sol)
...
```sh
forge test --contracts ./src/test/2022-07/SpaceGodzilla.exp.sol -vvv
```

#### Contract

[SpaceGodzilla.exp.sol](../../src/test/2022-07/SpaceGodzilla.exp.sol)
...
[FlippazOne.sol](../../src/test/2022-07/FlippazOne.sol)
...
```sh
forge test --contracts ./src/test/2022-06/XCarnival.exp.sol -vv
```

#### Contract

[XCarnival.exp.sol](../../src/test/2022-06/XCarnival.exp.sol)
...
```sh
forge test --contracts ./src/test/2022-06/Harmony_multisig.sol -vvvv
```

#### Contract

[Harmony_multisig.sol](../../src/test/2022-06/Harmony_multisig.sol)
...
```sh
forge test --contracts ./src/test/2022-06/Snood_poc.t.sol -vv
```

#### Contract

[Snood_poc.t.sol](../../src/test/2022-06/Snood_poc.t.sol)
...
```sh
forge test --contracts ./src/test/2022-04/Rari_exp.t.sol -vv
```

#### Contract

[Rari_exp.t.sol](../../src/test/2022-04/Rari_exp.t.sol)
...
```sh
forge test --contracts ./src/2022-04/others/deus_exp.sol -vv
```
...
```sh
forge test --contracts ./src/test/2022-04/Elephant_Money_poc.sol -vv
```

#### Contract

[Elephant_Money_poc.sol](../../src/test/2022-04/Elephant_Money_poc.sol)
...
```sh
forge test --contracts ./src/test/2022-01/Anyswap_poc.t.sol -vv
```

#### Contract

[Anyswap_poc.t.sol](../../src/test/2022-01/Anyswap_poc.t.sol)
