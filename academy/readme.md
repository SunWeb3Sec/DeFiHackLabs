...
- Lesson 5: Solidity Security - Lesson 5: Lending/Borrowing DeFi Attacks ([English](https://defihacklabs.substack.com/p/solidity-security-lesson-5-lendingborrowing))
