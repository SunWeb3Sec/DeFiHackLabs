...
Published on: [Slowmist](https://mp.weixin.qq.com/s/A2XQEWlH25o8YsWjwCz2HQ)
...
![图片](./慢雾出品 _ 余弦：区块链黑暗森林自救手册_files/640(1))
...
  a. C ustody，即托管方式。比如中心化交易所、钱包，用户只需注册账号，并不拥有私钥，安全完全依托于这些中心化平台
...
4. Shamir's Secret Sharing：S hamir 秘密共享方案，作用就是将种子分割为多个分片，恢复钱包时，需要使用指定数量的分片才能恢复
...
  b. 钱包运行时，当用户发起转账，在钱包后台偷偷替换目标地址及金额等信息，此时用户很难察觉<br>
...
2. 不要越狱、Root 破解，除非你玩安全研究，否则没必要<br>
